...
export function KonativeLogo() {
  return (
    <Link
      href="/"
      className="block shrink-0 rounded-md outline-none ring-offset-2 ring-offset-[color:var(--stitch-card)] focus-visible:ring-2 focus-visible:ring-[color:var(--stitch-accent-2)]"
